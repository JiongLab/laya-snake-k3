...
from snake_k3.game import DIRECTIONS, SnakeGame, hamiltonian_cycle
from snake_k3.policy import LayaPolicy, local_checkpoint
...
def test_recording_rejects_invalid_wall_clock_timestamps(tmp_path, times):
    from snake_k3.replay import load_record
